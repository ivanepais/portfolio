...
describe('PortfolioPageComponent', () => {
  ...
  it('initially display the charging status', async () => {
  ...
  it('display the portfolio when the upload is complete', async () => {
    ...
    expect(screen.queryByText('Loading portfolio...')).toBeNull();
