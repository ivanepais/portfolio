...
@Component({
  ...
  template: `
    <section
      id="hero"
      class="mx-auto max-w-2xl scroll-mt-20 bg-[url('assets/images/hero-background.svg')] bg-[right_top_0.2rem] bg-[size:350px_auto] md:bg-[size:420px_auto] bg-no-repeat pt-8"
    >
